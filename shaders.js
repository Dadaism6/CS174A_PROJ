...
class Modified_Phong_Shader extends Shader {
    ...
    fragment_glsl_code() {
        ...
        return this.shared_glsl_code() + `
            void main(){                                                           
                ...
                gl_FragColor.xyz += phong_model_lights( normalize( N ), vertex_worldspace, shape_color );
                } `;
    }
...
class Textured_Phong extends Modified_Phong_Shader {
